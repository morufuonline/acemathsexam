...
<li><a href="privates/testimonials/" class="<?php echo current_page("testimonials"); ?>"><i class="fa fa-comments" aria-hidden="true"></i> Testimonials</a></li>
<li><a href="privates/about-the-author/" class="<?php echo current_page("about-the-author"); ?>"><i class="fa fa-user" aria-hidden="true"></i> About Morufu Bello</a></li>
